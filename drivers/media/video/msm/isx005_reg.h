...
//
	...
	{0x02B8, 0x10, BYTE_LEN},		// VIF_CLKCONFIG1    - still                            
 	{0x02B9, 0x11, BYTE_LEN}, 		// VIF_CLKCONFIG2    - preview  10 ->64Mhz, 11->32Mhz    
...
init_reg_settings_array[] = {
	...
	// Only PLL
	// Input=24,out=Preview 32Mhz, Capture 64Mhz
	// YCorder CbYCrY
	// USER Ctrl
	//Preview size 640*480
	/* PCLK = 96Mhz
	{0x00FC,0x1f,BYTE_LEN}, 
{0x000b,0x03,BYTE_LEN}, 
{0x0009,0x06,BYTE_LEN}, 
{0x02C7,0x01,BYTE_LEN}, 
{0x0038,0x0D,BYTE_LEN}, 
{0x02B8,0x10,BYTE_LEN}, 
{0x02B9,0x11,BYTE_LEN}, 
{0x02BA,0x12,BYTE_LEN}, 
{0x02BB,0x13,BYTE_LEN}, 
{0x02BC,0x11,BYTE_LEN}, 
{0x02BD,0x12,BYTE_LEN}, 
{0x02BE,0x13,BYTE_LEN}, 
{0x02C0,0x10,BYTE_LEN}, 
{0x02C1,0x30,BYTE_LEN}, 
{0x4C10,0x11,BYTE_LEN}, 
{0x0348,0x30,BYTE_LEN}, 
{0x034A,0x11,BYTE_LEN},                        
{0x034C,0x30,BYTE_LEN},                        
{0x4044,0xC012,WORD_LEN},                      
{0x4046,0x1815,WORD_LEN},                      
{0x402B,0x85,BYTE_LEN},                        
{0x402C,0x9600,WORD_LEN},                      
{0x4060,0xC012,WORD_LEN},                      
{0x4062,0x1815,WORD_LEN},                      
{0x403E,0x5720,WORD_LEN},                      
{0x4074,0x0521,WORD_LEN},                      
{0x4040,0x491f,WORD_LEN},                      
{0x4076,0xF71F,WORD_LEN},                      
{0x02A2,0x0000,WORD_LEN},                      
{0x0364,0x2100,WORD_LEN},                      
{0x02A4,0x0700,WORD_LEN},                      
{0x02A6,0x0300,WORD_LEN},                      
{0x02A8,0x0000,WORD_LEN},                      
{0x4C14,0xE002,WORD_LEN},                      
{0x4C1C,0x4003,WORD_LEN},                      
...
{0x034F,0x01,BYTE_LEN},   	               
{0x0009,0x16,BYTE_LEN},	*/   
	{0x00FC,0xFC,BYTE_LEN}, 		 
	{0x000b,0x02,BYTE_LEN}, 		 
	{0x0009,0x06,BYTE_LEN}, 		 
	{0x02C7,0x01,BYTE_LEN}, 		 
	{0x0038,0x0D,BYTE_LEN}, 		 
	{0x02B8,0x10,BYTE_LEN}, 		 
	...
	{0x034A,0x11,BYTE_LEN}, 		 
	{0x034C,0x30,BYTE_LEN}, 		 
	{0x4044,0x800C,WORD_LEN},		 
	{0x4046,0x1815,WORD_LEN},		 
	{0x402B,0x59,BYTE_LEN}, 		 
	{0x402C,0x9600,WORD_LEN},		 
	{0x4060,0x800C,WORD_LEN},		 
	{0x4062,0x1815,WORD_LEN},		 
	{0x403E,0x001E,WORD_LEN},		 
	{0x4074,0x0521,WORD_LEN},		 
	{0x4040,0xF21C,WORD_LEN},		 
	{0x4076,0xF71F,WORD_LEN},		 
	{0x02A2,0x0000,WORD_LEN},		 
	{0x0364,0x2100,WORD_LEN},		 
	{0x02A4,0x0700,WORD_LEN},		 
...
af_macro_mode_reg_settings_array[] =
{
	...
	{0x4C52,0x2004,WORD_LEN},
	{0x4C54,0xD401,WORD_LEN},
	{0x4C56,0xDB00,WORD_LEN},
	{0x4C58,0xA004,WORD_LEN},
